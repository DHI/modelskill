...
def model_result(
    ...
    *,
    ...
    gtype: Optional[Literal["point", "track", "vertical", "unstructured", "grid"]] = None,
    **kwargs: Any,
) -> PointModelResult | TrackModelResult | VerticalModelResult | DfsuModelResult | GridModelResult:
