...
The following table shows which observation types can be matched with which model result types:

| Model Result Type | PointObservation | TrackObservation |
|-------------------|:----------------:|:----------------:|
| PointModelResult  | ✓ | ✗ |
| TrackModelResult  | ✗ | ✓ |
| GridModelResult   | ✓ | ✓ |
...
o1 = ms.observation("../data/SW/HKNA_Hm0.dfs0", gtype="point", name="HKNA")
mr = ms.model_result("../data/SW/HKNA_Hm0_Model.dfs0", gtype="point", name="SNS")
cmp = ms.match(o1, mr)
cmp
```
