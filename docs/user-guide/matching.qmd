...
In the simplest cases, Observation and ModelResult objects can be created using the factory functions [](`~modelskill.observation`) and [](`~modelskill.model_result`):

```{python}
import modelskill as ms
o1 = ms.observation("../data/SW/HKNA_Hm0.dfs0", item=0, x=4.2420, y=52.6887, name="HKNA")
mr = ms.model_result("../data/SW/HKNA_Hm0_Model.dfs0", item=0, x=4.2420, y=52.6887, name="Model")
cmp = ms.match(o1, mr)
cmp
```
