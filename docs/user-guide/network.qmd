...
```{python}
obs_1 = ms.NodeObservation(path_to_sensor_data_1, node=network.find(node="sensor_1"))
obs_2 = ms.NodeObservation(path_to_sensor_data_2, node=network.find(node="sensor_2"))
