...
When your data comes from a source other than a Res1D file, you can assemble a `Network` by subclassing the abstract base classes `NetworkNode` and `NetworkEdge`.
